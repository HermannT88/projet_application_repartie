...
public class Client {
     ...
     *
     * @param args Arguments en ligne de commande : args[0] (hôte du registre RMI)
     *             et args[1] (port du registre).
     * @throws RemoteException   En cas d'erreur réseau RMI.
     * @throws NotBoundException Si le service RMI recherché n'est pas lié dans
     *                           l'annuaire.
     */
    public static void main(String[] args) throws RemoteException, NotBoundException {
        ...
        // Adresse ip de la machine qui héberge le service, "localhost" si c'est sur
        // notre machine
        String host = args[0];
